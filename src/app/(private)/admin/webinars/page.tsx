...
import { AddWebinarForm } from "../_components/add-webinar-form";
...
const webinarItems: WebinarItemType[] = [
  {
    id: "1",
...
function WebinarCard({ item }: { item: WebinarItemType }) {
...
export default function WebinarsPage() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Webinars Management</h1>
