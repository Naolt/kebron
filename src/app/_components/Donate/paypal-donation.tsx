...
export default function PayPalDonation({ email }: { email: string }) {
    ...
    <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100/50 overflow-hidden">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-blue-900">PayPal Donation</CardTitle>
            <CardDescription>Quick and secure way to give</CardDescription>
          </div>
        </div>
      </CardHeader>
